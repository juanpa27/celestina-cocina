...
export default function MenuHeader() {
  return (
    ...
    >
      ...
      {/* Banda decorativa azulejo SVG — tile 150×150 px, repeat-x */}
      <div aria-hidden="true" style={{ marginTop: 20, marginLeft: -20, marginRight: -20, lineHeight: 0 }}>
        <div style={{
          borderTop: '2.5px solid #f2c14e',
          borderBottom: '2.5px solid #f2c14e',
          height: 150,
          backgroundImage: `url("data:image/svg+xml,${AZULEJO_SVG}")`,
